...
namespace YAMP
{
	...
	class SemiLogXFunction : PlotFunction
	{
		...
		public override Plot2DValue Function(MatrixValue m)
		{
			var plot = base.Function(m);
			plot.IsLogX = true;
			return plot;
		}
		...
		public override Plot2DValue Function(MatrixValue m, MatrixValue n)
		{
			var plot = base.Function(m, n);
			plot.IsLogX = true;
			return plot;
		}
	}
