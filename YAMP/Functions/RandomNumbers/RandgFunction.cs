...
namespace YAMP
{
    ...
    class RandgFunction : ArgumentFunction
    {
        ...
        [Example("randw(3)", "Gives a 3x3 matrix with gamma dist. rand. values.")]
        ...
        [Example("randw(3, 1)", "Gives a 3x1 matrix with gamma dist. rand. values.")]
        ...
        [Example("randw(3, 1, 10, 2.5)", "Gives a 3x1 matrix with gamma dist. rand. values around 10 with scale parameter theta set to 10 and shape parameter k set to 2.5.")]
