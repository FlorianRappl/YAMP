namespace YAMP
{
	...
	public class ReturnsAttribute : Attribute
    {
        ...
        /// <param name="explanationKey">The specific explanations</param>
        /// <param name="order">The rank of the return type</param>
		public ReturnsAttribute(Type type, String explanationKey, Int32 order = 0)
		{
            ReturnType = type;
		...
		/// </summary>
		public String ExplanationKey { get; private set; }
